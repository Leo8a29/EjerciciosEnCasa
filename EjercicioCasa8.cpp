...
//*************			Practica 9 Ejercicio Casa:	Mesa con texturas y silla con transparencia			******//
//************************************************************//
#include "texture.h"
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_image.LoadTGA("madera.tga");
	t_image.BuildGLTexture();
	t_image.ReleaseImage();

	tree.LoadTGA("silla.tga");
	tree.BuildGLTexture();
	tree.ReleaseImage();
}
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		prisma(cristal.GLindex, cristal.GLindex);// se le ponemos la imagent_image en lugar de t_metal se ve en todo
		glPopMatrix();
		...
		prisma(t_image.GLindex, t_image.GLindex);// se le ponemos la imagent_image en lugar de t_metal se ve en todo
		glPopMatrix();
	...
	glDisable(GL_TEXTURE_2D);
		...
		renderBitmapCharacter(-11, 10.5, -14, (void *)font, "Mesa de texturas y silla de transparencia");
